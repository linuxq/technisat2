...
enyo.path.addPaths({layout: "/home/marcel/Dropbox/webOS-Apps/Enyo2/bootplate/enyo/../lib/layout/", onyx: "/home/marcel/Dropbox/webOS-Apps/Enyo2/bootplate/enyo/../lib/onyx/", onyx: "/home/marcel/Dropbox/webOS-Apps/Enyo2/bootplate/enyo/../lib/onyx/source/"});
...
name: "serverAddress",
value: "http://marcel.homelinux.org:90",
...
name: "wslogin",
url: "",
onResponse: "processLogin",
callbackName: "callback"
}, {
kind: "WebService",
name: "wstimers",
url: "",
onResponse: "processTimers",
callbackName: "callback"
}, {
kind: "WebService",
name: "wsdeltimer",
url: "",
onResponse: "processDelTimer",
callbackName: "callback"
}, {
kind: "WebService",
name: "wsdeltimerconfirm",
url: "",
onResponse: "",
callbackName: "callback"
}, {
...
console.log(this.$.serverAddress.getValue() + " - " + this.$.serverPW.getValue()), this.$.wslogin.setUrl(TSAddress + "/index_s.html?sid=" + TSPWMD5 + "&submit=Login&detour="), this.$.wslogin.send();
},
buttonTimers: function(e) {
this.$.wstimers.setUrl(TSAddress + "/index_s.html?" + TSPWMD5 + "_timeroverview=Timer-%C3%9Cbersicht"), this.$.wstimers.send();
},
...
function SuchenUndErsetzen(e, t, n) {
if (e == null || t == null) return null;
if (e.length == 0 || t.length == 0) return e;
if (n == null || n.length == 0) n = "";
var r = t.length, i = n.length, s = e.indexOf(t, 0);
while (s >= 0) e = e.substring(0, s) + n + e.substring(s + r), s = e.indexOf(t, s + i);
return e;
}
...
}), JetztLesen = function(e, t, n, r) {
var i = e.indexOf(t, 0), s = e.indexOf(n, i), o = "", u = t.length;
switch (r) {
case 2:
i = e.indexOf(t, i + u);
break;
case 3:
i = e.indexOf(t, i + u), i = e.indexOf(t, i + u);
break;
case 4:
i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u);
break;
case 5:
i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u);
break;
case 6:
i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u);
break;
case 7:
i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u), i = e.indexOf(t, i + u);
}
return s = e.indexOf(n, i), o = e.substring(i + u, s), o;
}, gotJetzt = function(e) {
enyo.log("gotJetzt ausgeloest!"), Jetzt = e, Jetzt = SuchenUndErsetzen(Jetzt, "&ouml;", "\u00f6"), Jetzt = SuchenUndErsetzen(Jetzt, "&uuml;", "\u00fc"), Jetzt = SuchenUndErsetzen(Jetzt, "&auml;", "\u00e4"), Jetzt = SuchenUndErsetzen(Jetzt, "&Ouml;", "\u00d6"), Jetzt = SuchenUndErsetzen(Jetzt, "&Uuml;", "\u00dc"), Jetzt = SuchenUndErsetzen(Jetzt, "&Auml;", "\u00c4"), Jetzt = SuchenUndErsetzen(Jetzt, "&amp;", "&"), Jetzt = SuchenUndErsetzen(Jetzt, "&szlig;", "\u00df"), Jetzt = SuchenUndErsetzen(Jetzt, "<![CDATA[", ""), Jetzt = SuchenUndErsetzen(Jetzt, "]]>", ""), JetztImgUrl = this.JetztLesen(Jetzt, "<c>", "</c>", 3), GleichImgUrl = this.JetztLesen(Jetzt, "<c>", "</c>", 2), GleichInterpret = this.JetztLesen(Jetzt, "<i>", "</i>", 1), GleichTitel = this.JetztLesen(Jetzt, "<t>", "</t>", 1), GleichURL = this.JetztLesen(Jetzt, "<u>", "</u>", 1), JetztImgUrl = this.JetztLesen(Jetzt, "<c>", "</c>", 3), JetztImg = JetztImgUrl, JetztText = this.JetztLesen(Jetzt, "<w>", "</w>", 2), JetztInterpret = this.JetztLesen(Jetzt, "<i>", "</i>", 2), JetztTitel = this.JetztLesen(Jetzt, "<t>", "</t>", 2), JetztURL = this.JetztLesen(Jetzt, "<u>", "</u>", 2), TweetTitel = "'" + JetztTitel + "' von " + JetztInterpret, Vorh1ImgUrl = this.JetztLesen(Jetzt, "<c>", "</c>", 4), Vorh1Text = this.JetztLesen(Jetzt, "<w>", "</w>", 3), Vorh1Interpret = this.JetztLesen(Jetzt, "<i>", "</i>", 3), Vorh1Titel = this.JetztLesen(Jetzt, "<t>", "</t>", 3), Vorh1URL = this.JetztLesen(Jetzt, "<u>", "</u>", 3), Vorh2ImgUrl = this.JetztLesen(Jetzt, "<c>", "</c>", 5), Vorh2Text = this.JetztLesen(Jetzt, "<w>", "</w>", 4), Vorh2Interpret = this.JetztLesen(Jetzt, "<i>", "</i>", 4), Vorh2Titel = this.JetztLesen(Jetzt, "<t>", "</t>", 4), Vorh2URL = this.JetztLesen(Jetzt, "<u>", "</u>", 4), Vorh3ImgUrl = this.JetztLesen(Jetzt, "<c>", "</c>", 6), Vorh3Text = this.JetztLesen(Jetzt, "<w>", "</w>", 5), Vorh3Interpret = this.JetztLesen(Jetzt, "<i>", "</i>", 5), Vorh3Titel = this.JetztLesen(Jetzt, "<t>", "</t>", 5), Vorh3URL = this.JetztLesen(Jetzt, "<u>", "</u>", 5), Sendung = this.JetztLesen(Jetzt, "<n>", "</n>", 1), Moderator = this.JetztLesen(Jetzt, "<m>", "</m>", 1);
}, TweetOut = function(e) {
enyo.log("TWEETOUT " + e), e = "\u266b H\u00f6re gerade " + ClickTitel + " von " + ClickInterpret + " mit SWR3-Elchradio f\u00fcr HP webOS! \u266b ", params = {
action: "post",
msg: e
...
}, ImageFiltern = function(e, t, n) {
if (e == null || t == null) return null;
var r = e.length, i = e.indexOf(">", 0);
