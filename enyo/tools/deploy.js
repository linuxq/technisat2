...
shell.cp(path.join(sourceDir, 'index.html'), path.join(sourceDir, 'icon.png'), path.join(sourceDir, 'appinfo.json'), path.join(sourceDir, 'framework_config.json'), outDir);
